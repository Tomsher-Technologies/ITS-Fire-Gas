...
// Route::get('/products-sitemap.xml', [ProductController::class, 'generateProductSitemap']);
// Route::get('/categories-sitemap.xml', [ProductController::class, 'generateCategorySitemap']);
