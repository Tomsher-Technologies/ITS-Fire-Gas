<div>
    ...
    <div class="ps-panel__header">
        ...
        <form action="https://itsnew.tomsher.net/search" class="ps-form--search-mobile" method="get" id="mobile-search">
            <div class="form-group--nest">
                <input class="form-control" wire:model.debounce.500ms="query" name="keyword" type="text"
                            ...
                            <li class="suggestions__item ng-star-inserted">
                                <div class="suggestions__item-image product-image">
                                    <div class="product-image__body">
                                        <img data-ss="{{$product->thumbnail_img}}" class="product-image__img 112"
                                            src="{{ get_product_image($product->thumbnail_img) ?? frontendAsset('img/placeholder.webp') }}"
                                            alt="{{ $product->name }}" />
                                    </div>
                                </div>
