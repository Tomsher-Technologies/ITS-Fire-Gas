...
@section('meta')
    @if ($product->unit_price !== 0 && !$product->hide_price)
...
@section('content')
                        ...
                        <div class="ps-product__header">
                            ...
                            <div class="ps-product__info">
                                ...
                                @if ($product->hide_price || !hasStock($product))
                                    <p class="enquiry-notification">
                                        <b>
                                            ...
                                            target="blank" href="mailto:info@industrytechstore.com">info@industrytechstore.com</a>
                                        </b>
                                    </p>
                                @endif
                                ...
                                <div class="ps-product__sharing">
                                    ...
                                    <a class="linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode($c_url) }}" target="new">
    ...
    <div class="modal" id="new-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
.product-image-slider {
    width: 100%; /* Makes the slider container full width */
...
.slider-nav-thumbnails .item-thumb img {
    max-width: 100%;
    max-height: 100%;
    object-fit: contain;
}
...
$(document).ready(function() {
    ...
    <script>
         var myModal = bootstrap.Modal.getOrCreateInstance(document.getElementById('new-address-modal'));
    ...
    <script>
        ...
        $('#enquiry_form').on('submit', function(e) {
            ...
            if (!captchaResponse) {
                e.preventDefault();
                launchToast("Please complete the captcha.", 'error');
            }else{
                data = $(this).serialize();
                $.ajax({
                    type: "POST",
