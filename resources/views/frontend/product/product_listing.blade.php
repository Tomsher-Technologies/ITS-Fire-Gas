                    ...
                    <div class="ps-shopping ps-tab-root">
                        <div class="ps-shopping__header">
                            <p>Showing <strong> {{ $products->firstItem() }} to {{ $products->lastItem() }}
                                ...
                                @if ($category_id)
                                <h1>{{ Category::where('id', $category_id)->first()->name }}</h1>
                                @endif
                        ...
                        <div class="ps-tabs">
                            ...
                            @if ($category_id)
                                <h2>{{ Category::where('id', $category_id)->first()->footer_title }}</h2>
                                <h3>{!! Category::where('id', $category_id)->first()->footer_content !!}</h3>
                                @endif
                        </div>
                    </div>
                </div>
